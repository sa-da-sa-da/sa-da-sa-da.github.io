...
- name: sakaay
  desc: 当以读书通世事
  img: https://sakaay.com/favicon.ico
  link: https://sakaay.com/
- name: 我的公众号
  desc: 公众号 
  img: https://ossaiimages.sakaay.com/ai-image/sakaay/wc_gzh.webp
  link: https://ossaiimages.sakaay.com/ai-image/sakaay/wc_gzh.webp  
- name: 我的知乎
  desc: 知乎 
  img: https://sakaay.com/favicon.ico
...
- name: 我的b站
  desc: b站 
  img: https://sakaay.com/favicon.ico
  link: https://space.bilibili.com/485696789
- name: 我的相册
  desc: 相册 
  img: https://sakaay.com/favicon.ico
...
- name: VitePress 
  desc: VitePress官网
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress-logo-large-logo.svg
...
- name: 粥里有勺糖
  desc: 你的指尖,拥有改变世界的力量
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/sugarat.top-logo.jpeg
  link: https://sugarat.top/
- name: 查尔斯的知识库
  desc: 专注 & 洞察 & 分享
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/blog.charles7c.top-logo.png
  link: https://blog.charles7c.top/
  
- name: 无名小栈
  desc: 大佬，新颖，不错的VitePress主题
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/blog.imsyy.top-logo.png
  link: https://blog.imsyy.top/
- name: 云雀Lark
  desc: 类似 无名小栈 风格网站
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/cloudlark.cn.webp
  link: https://cloudlark.cn/
- name: Lumen Enhanced Theme
  desc: 集成 Vue 功能组件和主题美化的 VitePress 插件
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/lumen.theojs.cn-logo.webp
...
- name: 罗磊的独立博客 
  desc: 首页文章卡片式风格
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/luolei.org-logo.png
  link: https://luolei.org/
- name: APP比比
  desc: 首页文章卡片式风格
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/www.appbeebee.com-logo.png
  link: https://www.appbeebee.com/ 
- name: 科技语者
  desc: 首页文章卡片式风格
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/blog.uopy.top.png
  link: https://blog.uopy.top/
- name: 星辰起点
  desc: 用飞书写博客,并自动部署
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/feishu-vitepress.png
...
- name: LeavesMC 文档
  desc: 体验不错的布局切换风格
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/docs.leavesmc.org.svg
  link: https://docs.leavesmc.org/zh_Hans/
- name: leelaa blog
  desc: 多个有趣的元素，有趣的vitepress主题
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/leelaa.cn-logo.webp
  link: https://leelaa.cn/
- name: 茂茂物语
  desc: 吾志所向，一往无前。
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/notes.fe-mm.com-logo.png
- name: Easy VitePress Blog
  desc: 好看的友链和开源项目风格
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/example.zbwer.work-logo.png
  link: https://example.zbwer.work/
- name: Sensei's 部落格
  desc: 有趣的vitepress主题
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress-theme-bluearchive-logo.webp
  link: https://vitepress-theme-bluearchive.vercel.app/
- name: VitePress Sidebar功能强大的自动侧边栏生成器
  desc: 功能强大的自动侧边栏生成器
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress-sidebar.cdget.com-logo.png
  link: https://vitepress-sidebar.cdget.com/zhHans/
- name: vite-plugin-vitepress-auto-sidebar
  desc: 自动侧边栏插件
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vite-plugin-vitepress-auto-sidebar-logo.jpg
  link: https://github.com/QC2168/vite-plugin-vitepress-auto-sidebar
- name: Hello, sakura
  desc: 可爱又轻量的二次元博客主题
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/flaribbit-logo.png
  link: https://flaribbit.github.io/vitepress-theme-sakura/
- name: Vitepress Demo Plugin实时预览你的DEMO
  desc: 实时预览你的DEMO
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress-demo.fe-dev.cn.svg
  link: https://vitepress-demo.fe-dev.cn/
- name: vitepress-plugin-51la
  desc: 为 VitePress 站点引入 51.la 的网站数据统计能力。
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress-plugin-51la.ico
  link: https://github.com/ATQQ/sugar-blog/tree/master/packages/vitepress-plugin-51la
- name: nolebase
  desc: 记录回忆，知识和畅想的地方
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/nolebase.ayaka.io-logo.svg
  link: https://nolebase.ayaka.io/zh-CN/
- name: dddssw'blog
  desc: 由 Vitepress，Vue，Gsap，Canvas 提供支持，集成 Algolia 等......
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/dddssw.github.io-logo.jfif
  link: https://dddssw.github.io/blog/
- name: Vitepress Open17
  desc: 简单美观的博客主题
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress.open17.vip.png
...
- name: 友人A
  desc: vitepress博客
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/niubin.site-logo.jpg
  link: http://niubin.site/ 
- name: 野宁新之助
  desc: vitepress博客
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/www.sanghangning.cn-logo.png
  link: https://www.sanghangning.cn/   
- name: 空荧酒馆
  desc: vitepress博客
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/yuanshen.site-logo.png
...
- name: ZiuChen
  desc: 无限进步
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/ziuchen.github.io.png
  link: https://ziuchen.github.io/
- name: VitePress会员主题
  desc: 基于VitePress默认主题做扩展，实现部分内容会员可见，用于做知识付费文档网站。
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress.mosong.cc.webp
  link: https://vitepress.mosong.cc/   
- name: 唯知笔记
  desc: 探索知识的无限可能
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/note.weizwz.com.png
  link: https://note.weizwz.com/
- name: LI SIR - 个人博客
  desc: 你的时间花在哪里，你的收获就在哪里
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/lisir.me.png
  link: https://lisir.me/
```
...
- name: vite-plugin-vitepress-auto-nav
  ...
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vite-plugin-vitepress-auto-nav.png
  link: https://github.com/Xaviw/vite-plugin-vitepress-auto-nav   
- name: vitepress-plugin-lightbox
  desc: VitePress 插件增加了对在灯箱中查看图像的支持。
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress-plugin-lightbox.jpg
...
- name: markdown-it-link-to-card
  ...
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/markdown-it-link-to-card.jpg
...
- name: vitepress-auto-nav-sidebar
  ...
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress-auto-nav-sidebar.png
...
- name: 掘金-VitePress搭建文档博客系列
  ...
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/7288992783581396992.png
  link: https://juejin.cn/column/7288992783581396992 
- name: OhMyLive2D 看板娘
  desc: 高可自定义且开箱即用的 Live2D For Web 组件, 快速为您的个人网站加入Live2D看板娘
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/oml2d.hacxy.cn.png
  link: https://oml2d.hacxy.cn/
- name: www.live2d.com 看板娘
  desc: 可以直接对原图进行加工，做出2D的立体表现。角色展示魅力十足，引人入胜。
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/www.live2d.com.png
  link: https://www.live2d.com/zh-CHS/
- name: vitepress-plugin-rss
  desc: vitepress可用的rss插件
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress-plugin-rss.png
...
- name: VitePress Plugin Ext
  ...
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vitepress-ext.leelaa.cn.png
...
- name: Grtsinry43’s Blog
  desc: 总之岁月漫长，然而值得等待 
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/blog.grtsinry43.com.jpeg 
  link: https://blog.grtsinry43.com/
- name: 小张的个人博客
  desc: 为什么每天不能睡25个小时啊
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/mrzym.top.png 
  link: http://mrzym.top/
- name: Ruyu-blog
  desc: 生活想要活埋了我，不料我是一粒种子
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/Ruyu-blog.webp 
  link: https://www.kuailemao.xyz/
- name: 张洪Heo
  desc: 分享设计与科技生活
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/blog.zhheo.com.png 
  link: https://blog.zhheo.com/
- name: Naccl's Blog
  desc: 愿你有一天能与你最重要的人重逢
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/naccl.top.jpg
  link: https://naccl.top/
- name: 蘑菇博客
  desc: 蘑菇社区
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/www.moguit.cn.png 
  link: https://www.moguit.cn
- name: 崔亮的博客
  desc: 运维开发大佬
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/www.cuiliangblog.cn.png
  link: https://www.cuiliangblog.cn/
- name: 互联网运维技术分享
  desc: 本站由Django慢慢驱动
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/starsl.cn.png
...
- name: VuePress
  desc: Vue 驱动的静态网站生成器
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/VuePress.png
  link: https://vuepress.vuejs.org/zh/
- name: hugo
  desc: The world’s fastest framework for building websites
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/gohugo.io.svg
  link: https://gohugo.io/
- name: Docusaurus
  desc: 快速构建以内容为核心的最佳网站
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/docusaurus.svg
  link: https://docusaurus.io/
- name: Valaxy
  desc: 下一代静态博客框架
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/Valaxy.svg
  link: https://valaxy.site/
- name: Rspress
  desc: 快如闪电的静态站点生成器（简单、高性能、易于扩展）
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/rspress.uihtm.com.png
...
- name: HB 框架
  ...
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/zh-hans.hbstack.dev.png
...
- name: Vue Bits
  ...
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vue-bits.dev.png
...
- name: Hyde Blog
  desc: 前端大佬,666 
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/hyde-logo.ico 
  link: https://hyde.seasir.top/  
- name: vdoing
  desc: vdoing官网
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vuepress-theme-vdoing.png 
  link: https://doc.xugaoyi.com/ 
- name: Evan's blog 官方 
  desc: Web前端技术博客，积跬步以至千里 
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/xugaoyi.png 
  link: https://xugaoyi.com/ 
- name: 从01开始
  desc: 那就从零开始
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/从01开始.jpg
  link: https://www.peterjxl.com/
- name: 二丫讲梵 
  desc: 💻学习📝记录🔗分享 
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/eryajiangfan.png 
  link: https://wiki.eryajf.net/ 
- name: Young Kbt blog
  desc: 故事由我书写，旅程由你见证，传奇由她聆听 
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/Kbt.png 
  link: https://notes.youngkbt.cn/    
- name: Manchan's blog
  desc: 那就从零开始
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/Manchan-img.webp
...
- name: Java 全栈知识体系
  desc: Java 全栈知识体系
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/Java全栈知识体系.jpg
  link: https://www.pdai.tech/
- name: 兰德胡涂
  desc: 不错的vdoing网站
  # img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/landhutu.png
  img: https://img.onedayxyy.cn/images/landhutu.png
  link: https://landhutu.top/
- name: 虫术
  desc: vdoing用户
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/spiderapi.png
...
- name: Typecho Themes
  desc: Typecho Themes
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/typechx.com.png
...
- name: OneBlog
  desc: 一个简约唯美的主题
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/oneblogx.com.png
...
- name: 壁纸汇
  ...
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/bizhihui.png
  link: https://www.bizhihui.com/
- name: hdqwalls.com
  desc: 壁纸
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/hdqwalls.png
...
- name: 暮冬浅夏 资源站
  desc: 祖国必将统一！
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/iiikun.png
...
- name: openi
  desc: 导航网站
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/openi.png
  link: https://openi.cn/
```
...
- name: element-plus
  ...
  img:  https://img.onedayxyy.cn/images/Teek/Teekwebsite/element-plus.svg
```
:::
...
- name: md2.sleele.com
  desc: 正在使用，不错
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/md2.sleele.com.png 
...
- name: 千帆搜索
  desc: 正在使用，不错
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/pan.qianfan.app.svg
...
- name: 简悦
  desc: 正在使用的剪藏软件，不错
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/simpread.pro.png
...
- name: VLC Media Player
  desc: 视频播放软件
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/vlc.png
...
- name: Imagine
  ...
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/imagine.png
...
- name: 哲风壁纸
  desc: 好看的壁纸网站
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/haowallpaper.com.ico
...
- name: PicList
  ...
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/piclist.png
  link: https://piclist.cn/
  badge: 强烈推荐
- name: PicGo
  desc: 图片上传、管理新体验
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/picgo.png
  link: https://picgo.github.io/PicGo-Doc/
- name: utools
  desc: 里面含有图床插件
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/www.u-tools.cn.png
  link: https://www.u-tools.cn/
- name: ShareX
  desc: 可以把图片上传到服务器某个目录下同时保存图片到本地
  img: https://img.onedayxyy.cn/images/Teek/Teekwebsite/getsharex.com.png
